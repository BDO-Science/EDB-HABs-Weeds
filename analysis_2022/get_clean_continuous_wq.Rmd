...
```{r}
saveRDS(flow_clean, here(data_root,"CDEC_flow_SJC_LIB__FCT_2013_2022.rds"), compress = "xz")
flow_clean <- readRDS(here(data_root,"CDEC_flow_SJC_LIB_FCT_2013_2022.rds"))
```
...
```{r}
f_get_NWIS <- function(siteNumbers=11312676, parameterCd = c('00010','63680', '00095', '00400', '00300', '32316'), startDate = "2013-01-01", endDate = "2022-11-01", tz = "Etc/GMT+8"){
