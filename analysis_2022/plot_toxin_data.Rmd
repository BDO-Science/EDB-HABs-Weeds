...
(map_cyano <- ggplot()+
  ...
  scale_shape_manual(values = c(18, 2, 15, 3, 7, 8, 1)) +
  theme_bw()+
...
health = data.frame(Analyte = c("Microcystins", "Microcystins", "Microcystins", "Anatoxins","Anatoxins", "Cylindrospermopsins", "Cylindrospermopsins"), Advisory = c(0.8, 6,20, .5, 20, 1, 4),
...
### All data
```{r}
ggplot(ct_all, aes(x = Date, y = Result)) +
