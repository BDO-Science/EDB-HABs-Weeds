#LHE notes: Reusing most of the 2021 code to obtain 2022 data for the updated report: HABS satellite data
...
options(download.file.method = "wininet") #Lets you add packages if you don't already have them
# Load packages
library(dplyr)
library(tidyr)
library(readr)
...
setwd("~/GitHub/EDB-HABs-Weeds/EDB/EDBdata/data-raw")
...
# Download HAB satellite data if necessary
 ...
 # dir_hab_sat <- here("data-raw/HAB_satellite_data")
  ...
  # Download data for June-October in 2019-2022
...
#}
#I found it was more straightforward to create the subdirectory, download the sentinel-3 data manually from https://fhab.sfei.org for months 6-10, and then delete the sentinel-3B files.

# Create a vector of all file paths for the HAB satellite data
#hab_dir <- "C:/Users/lelliott/OneDrive - DOI/Documents/GitHub/EDB-HABs-Weeds/EDB/EDBdata/data-raw/HAB_satellite_data"
hab_dir <- "C:/Users/lelliott/OneDrive - DOI/Documents/GitHub/EDB-HABs-Weeds/EDB/EDBdata/data-raw/HAB_satellite_data_2019_2021"
fp_hab_sat <- dir(path = hab_dir, pattern = ".tif$", full.names = TRUE)
...
sf_ow_delta <- read_sf("C:/Users/lelliott/OneDrive - DOI/Documents/GitHub/EDB-HABs-Weeds/EDB/Spatial_data/Franks_Mildr_CCF_LibIsl.shp")

HNAME <- c("Franks Tract", "Mildred Island", "Clifton Court Forebay", "Liberty Island") #The shape file provided didn't have an HNAME variable, so I added it
sf_ow_delta_c <- cbind(sf_ow_delta, HNAME)
# Clean up shapefile of the open water regions with a more descriptive column header
sf_ow_delta_c <- sf_ow_delta_c %>% rename(Region = HNAME)
...
# for easier diffing
#f_name <- "C:/Users/lelliott/OneDrive - DOI/Documents/GitHub/EDB-HABs-Weeds/EDB/hab_sat_ow_delta2022_Nov.csv"
f_name <- "C:/Users/lelliott/OneDrive - DOI/Documents/GitHub/EDB-HABs-Weeds/EDB/hab_sat_ow_delta2019_2021_Nov.csv"
write_csv(hab_sat_ow_delta, f_name)
