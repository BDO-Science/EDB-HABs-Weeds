...
```{r}
saveRDS(flow_clean, here(data_root,"CDEC_flow_SJC_LIB_2013_2022.rds"))
flow_clean <- readRDS(here(data_root,"CDEC_flow_SJC_LIB_2013_2022.rds"))
```
...
```{r}
saveRDS(vel_clean, here("analysis_2022", "data_raw", "CDEC_velocity_2013_2022.rds"))
...
```{r}
f_get_NWIS <- function(siteNumbers=11312676, parameterCd = c('00010','63680', '00095', '00400', '00300', '32316'), startDate = "2022-01-01", endDate = "2022-11-01", tz = "Etc/GMT+8"){
...
f_get_NWIS_flow <- function(siteNumbers=11312676, parameterCd = c('00060'), startDate = "2013-01-01", endDate = "2022-11-01", tz = "Etc/GMT+8"){
...
f_get_NWIS_vel <- function(siteNumbers=11312676, parameterCd = c('72255'), startDate = "2013-01-01", endDate = "2022-11-01", tz = "Etc/GMT+8"){
...
data_USGS <- rbind(MDM_comb, MDM_vel, ORQ, DSJ, SJG, FAL, FAL_vel, HLT, HOL, OSJ) 
```
