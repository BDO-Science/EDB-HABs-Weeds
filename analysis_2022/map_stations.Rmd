...
```{r}
png(filename = here("analysis_2022", "figures", "map_wq.png"), width = 6, height = 8, units = "in", pointsize = 12, family = "sans", res = 300)
wq_map
dev.off()
...
(map_phyto_micro <- ggplot()+
  ...
  geom_sf(data = WW_Delta, color = "steelblue3", fill = "lightblue", alpha = 0.5, lwd = 0.5)+
