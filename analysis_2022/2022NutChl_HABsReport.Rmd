...
```{r}
Nuts_pre22 <- read_csv("data_raw/hab_nutr_chla_mvi.csv")
...
```{r}
tucp_dates <- read_excel("C:/Users/karend/Desktop/HABs_AqVeg/EDB-HABs-Weeds/data/tucp_dates.xlsx")%>%
...
Disc_Nut_Stations = nutssf_TUCP %>%
  select(Source, Station, Year, Stratum2, colors) %>%
  filter(Year %in% 2022,
...
Nuts_2022_plots = (plot_Cache_2022nuts + plot_LowerSJ_2022nuts + plot_Franks_2022nuts + plot_OMR_2022nuts + plot_SDelta_2022nuts) + plot_layout(ncol = 2, widths = c(30,30)) 
```
