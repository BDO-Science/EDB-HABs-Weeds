...
(wq_map <- ggplot() + 
  ...
  annotation_north_arrow(location = "tr", which_north = "true",
                             ...
                             style = north_arrow_fancy_orienteering) +
      annotation_scale(location = "bl", bar_cols = c("black", "white", "black", "white")) +
   scale_color_manual(values = c("coral","blue4")) + 
  theme_bw())
```
...
png(filename = here("analysis_2022", "figures", "cont_map.png"), width = 6, height = 8, units = "in", pointsize = 12, family = "sans", res = 300)
cont_map
dev.off()
```
