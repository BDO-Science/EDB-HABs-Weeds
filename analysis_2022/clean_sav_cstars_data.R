...
#only generate the figures needed for the report.
...
## Get latitudes and longitudes in sf --------------------------
...
#data reformatting for the Big Break
...
#2022 Big Break data
bb <- read.dbf(here("analysis_2022", "data_raw", "Veg", "BBgrid_2022.dbf"))
...
## Reformat to Cstars 2021 format ------------------------------
...
sj <- read.dbf(here("analysis_2022", "data_raw", "Veg", "SAVFLOAT.dbf"))
...
#begin combining reformatted data.
...
# Write file -----------------------------------------
write_csv(cstars, here("analysis_2022", "data_clean", "SAV_cstars_bb_frk_sj_2022.csv"))
